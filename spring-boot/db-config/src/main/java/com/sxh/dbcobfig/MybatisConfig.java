...
*/
@Configuration
@MapperScan(value = "com.cloudfish.mapper")//,sqlSessionTemplateRef = "sqlSessionTemplatePrimary"
public class MybatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("primaryDataSource") DataSource primaryDataSource,
        ...
        targetDataSources.put(DynamicDataSource.DatabaseType.testDataSource, testDataSource);
